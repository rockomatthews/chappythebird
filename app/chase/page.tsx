        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="glass rounded-2xl p-8 sm:p-12 mb-12 max-w-2xl mx-auto">
            <div className="text-center mb-8">
              <div className="text-5xl sm:text-6xl font-bold text-[--color-gold] tracking-tight mb-2">
                {formattedBalance}
              </div>
              <div className="text-lg sm:text-xl text-[--color-paper]/75 mb-4">
                of {formattedTarget}
              </div>
              <div className="text-sm mono text-[--color-mute]">
            ...
            <div className="mb-8">
              <div className="w-full h-3 bg-white/5 rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-[--color-gold] to-[--color-rust] transition-all duration-500"
                  style={{ width: `${progressPercent}%` }}
                />
              </div>
              <div className="flex justify-between text-xs text-[--color-mute] mt-3">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              <div className="border border-white/10 rounded-lg p-4">
                ...
                <div className="text-2xl font-semibold text-[--color-paper]">
                  {formattedBalance}
                </div>
              </div>
              <div className="border border-white/10 rounded-lg p-4">
          ...
          <div className="max-w-2xl mx-auto space-y-6">
            <div className="glass rounded-xl p-6 text-left">
              ...
              <a
                href="/log"
                className="text-sm font-medium text-[--color-gold] hover:text-[--color-gold]/80 transition"
              >
                Read the daily log →
              </a>
            </div>
            ...
            <div className="glass rounded-xl p-6 text-left">
              ...
              <p className="text-sm text-[--color-paper]/80 leading-relaxed">
